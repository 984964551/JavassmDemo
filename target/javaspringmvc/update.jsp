...
<form action="/user/updateuser" method="post">
    ...
    <c:if test="${user.sex=='女'}">
        ...
        <input type="radio" name="sex" value="女" id="female"checked>女
    </c:if>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="exampleInputPassword2" name="adress" value="${user.adress}">
    </div>
    <div class="form-group">
        <label for="exampleInputPassword3">QQ</label>
        <input type="text" class="form-control" id="exampleInputPassword3" name="qq" value="${user.qq}">
    </div>
    <div class="form-group">
        <label for="exampleInputPassword4">邮箱</label>
        <input type="text" class="form-control" id="exampleInputPassword4" name="email" value="${user.email}">
    </div>
