...
<div class="all">
    ...
    <div class="right">
        <a href="${pageContext.request.contextPath}/login.jsp"><h3>有账号？点击登录</h3></a>
    </div>
    <div class="center">
        <div class="form">
            <form action="/admin/regist" method="post" id="form">
                <table>
                    <tr>
                        ...
                        <td> <div class="wrong">${username_error}</div></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" align="center" ><input type="submit"  value="注册" id="buttons-hbox"></td>
                    </tr>
